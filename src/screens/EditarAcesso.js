...
export default class EditarAcesso extends Component {
    ...
    getDados = async () => {
        const BASE_URL = "http://ec2-52-67-64-140.sa-east-1.compute.amazonaws.com:3000/user/editAcesso/"+this.state.id;
    ...
    changeSituation = async () => {
        const BASE_URL = "http://ec2-52-67-64-140.sa-east-1.compute.amazonaws.com:3000/user/deleteAcesso/"+this.state.id;
