...
export default class EditarUsuario extends Component{
    ...
    getDados = async () => {
        const BASE_URL = "http://ec2-52-67-210-198.sa-east-1.compute.amazonaws.com:3000/user/editUser/"+this.state.id;
    ...
    changeSituation = async () => {
        const BASE_URL = "http://ec2-52-67-210-198.sa-east-1.compute.amazonaws.com:3000/user/deleteUser/"+this.state.id;
